...
ty_decl :: { LTyClDecl GhcPs }
        ...
        | data_or_newtype opt_unlifted capi_ctype tycl_hdr constrs maybe_derivings
...
at_decl_inst :: { LInstDecl GhcPs }
        ...
        | data_or_newtype opt_unlifted opt_unlifted opt_instance capi_ctype datafam_inst_hdr opt_kind_sig
                 gadt_constrlist
                 maybe_derivings
...
comb5 :: (HasSrcSpan a , HasSrcSpan b , HasSrcSpan c , HasSrcSpan d , HasSrcSpan e) =>
         a -> b -> c -> d -> e -> SrcSpan
